<template>
  <div class="h-screen bg-black flex overflow-hidden">
    ...
    <aside
      v-if="isClient"
      @click.stop
      class="fixed lg:fixed left-0 top-16 lg:top-0 h-[calc(100vh-4rem)] lg:h-screen bg-dark-900 border-r border-dark-700 flex flex-col z-40 transition-all duration-300 overflow-visible"
      :class="[
    ...
    >
      <!-- Logo and Toggle -->
      <div
        class="hidden lg:flex h-16 items-center border-b border-dark-700 flex-none shrink-0 transition-all duration-300"
        :class="[
        // CHANGED: Check for mobile/tablet as well
        (isMobile || isTablet) ? 'justify-between px-4 sm:px-6' : 
      ...
      >
        <NuxtLink 
          ...
          <span 
            v-if="!isCollapsed || isMobile || isTablet" 
            class="text-white text-xl font-semibold truncate transition-opacity duration-300"
            :class="{ 'opacity-0': isCollapsed && !(isMobile || isTablet) }"
          >
            provento.ai
          </span>
        </NuxtLink>
        ...
        <button v-if="!isMobile && !isTablet" @click="toggleSidebar"
          class="h-8 w-8 flex items-center justify-center rounded-md bg-dark-800 hover:bg-dark-700 text-gray-300 hover:text-white transition-colors duration-200 flex-shrink-0"
          :title="isCollapsed ? 'Expand sidebar' : 'Collapse sidebar'">
          <UIcon :name="isCollapsed ? 'heroicons:chevron-right' : 'heroicons:chevron-left'" class="w-4 h-4" />
        </button>

      </div>

      <!-- Admin Navigation -->
      <nav class="flex-1 p-4 overflow-y-auto overflow-visible">
        <div class="space-y-1">
          <!-- Dashboard menu -->
          ...
          <template v-if="showOrganizationMenusForSuperAdmin">
            <SidebarButton
              ...
              :tooltip="isProfileComplete ? 'Dashboard' : 'Complete your profile to access this section'"
            />
            ...
            <SidebarButton
              ...
              :collapsed="isMobile || isTablet ? false : isCollapsed"
              :disabled="!isProfileComplete"
              :tooltip="isProfileComplete ? 'Users' : 'Complete your profile to access this section'"
            />
            ...
            <SidebarButton
              ...
              :collapsed="isMobile || isTablet ? false : isCollapsed"
              :disabled="!isProfileComplete"
              :tooltip="isProfileComplete ? 'Artifacts' : 'Complete your profile to access this section'"
            />
            ...
            <SidebarButton
              ...
              :collapsed="isMobile || isTablet ? false : isCollapsed"
              :disabled="!isProfileComplete"
              :tooltip="isProfileComplete ? 'Analytics' : 'Complete your profile to access this section'"
            />
            ...
            <SidebarButton
              ...
              :collapsed="isMobile || isTablet ? false : isCollapsed"
              :disabled="!isProfileComplete"
              :tooltip="isProfileComplete ? 'Plans' : 'Complete your profile to access this section'"
            />
            ...
            >
              <button
                ...
                @click="!isCollapsed || isMobile || isTablet ? (integrationsOpen = !integrationsOpen) : null"
                ...
                :disabled="!isProfileComplete"
                :title="(isCollapsed && !(isMobile || isTablet)) ? 'Integrations' : (isClient && !isProfileComplete ? 'Complete your profile to access this section' : 'Integrations')"
                @mouseenter="handleIntegrationsMouseEnter"
              >
                <div class="flex items-center" :class="{ 'space-x-3': !isCollapsed || isMobile || isTablet }">
              ...
              >
                <div class="bg-dark-800 border border-dark-700 rounded-lg shadow-lg py-2 min-w-[200px]">
                ...
                <div class="space-y-1 px-1">
                  <SidebarButton
                    ...
                    :icon="'heroicons:eye'"
                    :active="$route.name === 'admin-integrations' || pendingRoute === 'admin-integrations'"
                    :collapsed="false"
                    size="sm"
                    tooltip="Overview"
                  ...
                  <SidebarButton
                    ...
                    :icon="'i-mdi:slack'"
                    :active="$route.name === 'admin-integrations-slack' || pendingRoute === 'admin-integrations-slack'"
                    :collapsed="false"
                    size="sm"
                    tooltip="Slack"
                    class="justify-start w-full"
                  ...
                  <SidebarButton
                    ...
                    :active="$route.name === 'admin-integrations-teams' || pendingRoute === 'admin-integrations-teams'"
                    :collapsed="false"
                    size="sm"
                    tooltip="Teams"
                    class="justify-start w-full"
                  ...
                  <SidebarButton
                    ...
                    :icon="'i-mdi:whatsapp'"
                    :active="$route.name === 'admin-integrations-whatsapp' || pendingRoute === 'admin-integrations-whatsapp'"
                    :collapsed="false"
                    size="sm"
                    tooltip="WhatsApp"
                    class="justify-start w-full"
                  ...
                  <SidebarButton
                    ...
                    :active="$route.name === 'admin-integrations-i-message' || pendingRoute === 'admin-integrations-i-message'"
                    :collapsed="false"
                    size="sm"
                    tooltip="iMessage"
                    class="justify-start w-full"
...
function makeOrgLink(path: string) {
  try {
    ...
    const query = route && route.query as any
    const q = query?.org || query?.org_id
      ? { org: String(query.org || query.org_id) }
      : {}
